...
;
export class AltitudeIndicator extends DisplayComponent {
    constructor() {
        super(...arguments);
    ...
    render() {
        ...
        return (FSComponent.buildComponent("g", null,
            ...
            FSComponent.buildComponent(VerticalTape, { bugs: [], displayRange: DisplayRange + 30, valueSpacing: ValueSpacing, distanceSpacing: DistanceSpacing, lowerLimit: -1500, upperLimit: 50000, tapeValue: this.subscribable, type: 'altitude' })));
    }
}
;
 ...
 */ 
//# sourceMappingURL=AltitudeIndicator.js.map